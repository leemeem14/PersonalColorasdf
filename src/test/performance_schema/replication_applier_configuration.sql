...
(
    ...
    PRIVILEGE_CHECKS_USER                        text                                     null comment 'User name for the security context of the applier.',
    ...
    ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_VALUE text                                     null comment 'Indicates the UUID used while generating GTIDs for anonymous transactions'
);

create unique index `PRIMARY`
    on performance_schema.replication_applier_configuration (CHANNEL_NAME)
    using hash;
