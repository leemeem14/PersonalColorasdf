...
(
    ...
    HOST              char(255)    not null comment 'The source hostname that the replica will attempt to switch over the replication connection to in case of a failure.',
    ...
    MANAGED_NAME      char(64)     not null comment 'The name of the group which this server belongs to.'
);
