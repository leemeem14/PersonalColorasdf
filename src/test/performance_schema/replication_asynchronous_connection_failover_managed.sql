...
(
    ...
    MANAGED_NAME  char(64) not null comment 'The name of the source which needs to be managed.',
    MANAGED_TYPE  char(64) not null comment 'Determines the managed type.',
